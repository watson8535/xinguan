package com.edward.test.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //%s 为占位符 例如：%sAction 生成 UserActon
        //mp生成service层代码，默认接口名称第一个字母是有I
        gc.setServiceName("%sService");
        //设置主键生成策略 自动增长
        gc.setIdType(IdType.AUTO);
        //设置Data类型 只使用 java.util.date 代替
        ...
        //设置实体类命名格式为驼峰命名 下划线转驼峰
        strategy.setNaming(NamingStrategy.underline_to_camel);
        //设置列名命名格式为驼峰命名
        strategy.setColumnNaming(NamingStrategy.underline_to_camel);
        //使用lombok简化getter和setter
        strategy.setEntityLombokModel(true);
        //设置controller的api风格  使用RestController
        strategy.setRestControllerStyle(true);
        //url驼峰转连字符  例如：isUser 为 is-user
