...
import com.edward.system.entity.OssEntity;
...
/**
 * 在创建 AliossServiceImpl 时就应该把属性值装载好
 */
@Service
public class AliossServiceImpl implements AliossService, InitializingBean {
    ...
    public String upload(MultipartFile file) {
        ...
        try {
            ...
            //构建日期的文件夹路径  avatar/2021/2/10/文件名
            String datePath = new DateTime().toString("yyyy/MM/dd");

            //获取上传文件的全名称
            String originalFilename = file.getOriginalFilename();

            //获取UUID  a98059d4-633c-4b55-b310-93c997cf8038 去掉"-"
            String fileName = UUID.randomUUID().toString().replace("-", "");

            //获取上传文件的扩展名  .jpg
            String fileType = originalFilename.substring(originalFilename.lastIndexOf("."));

            //拼接文件名称 a98059d4633c4b55b31093c997cf8038.jpg
            String newName = fileName + fileType;

            //生成文件夹   avatar/2021/2/10/a98059d4633c4b55b31093c997cf8038.jpg
            fileName = datePath + "/" + newName;

            /*
            * 如果要实现图片预览的效果，一定要设置以下几点
            * 1、设置文件的ACL(权限)  要么公共读 要么公共读写
            ...
            **/
            ...
            //每次上传图片的名字不能相同，在java中如何让每次生成的名字不同？
            // 1 uuid  2 redis分布式ID  3 雪花算法   为了方便区分，这边的文件格式为yyyy/MM/dd + uuid
